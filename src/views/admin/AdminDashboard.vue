  ...
  <div class="dashboard">
    ...
    <div class="dashboard__stats">
      <div
        ...
        :key="stat.label"
        class="dashboard__stat reveal"
        :class="`reveal--d${i + 1}`"
      >
        <span class="dashboard__stat-icon">
          <svg
            v-if="stat.label === 'Utilisateurs'"
            viewBox="0 0 24 24"
            width="22"
            height="22"
            fill="none"
          ...
          <svg
            v-else-if="stat.label === 'Catégories'"
            viewBox="0 0 24 24"
            width="22"
            height="22"
            fill="none"
          ...
          <svg
            v-else-if="stat.label === 'Commandes'"
            viewBox="0 0 24 24"
            width="22"
            height="22"
            fill="none"
          ...
          <svg
            v-else-if="stat.label === 'Paiements'"
            viewBox="0 0 24 24"
            width="22"
            height="22"
            fill="none"

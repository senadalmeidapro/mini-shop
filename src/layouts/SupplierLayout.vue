      ...
      <div class="supplier__brand">
        <span class="supplier__logo">
          <svg viewBox="0 0 32 32" width="32" height="32" fill="none">
            ...
            <path
              d="M8 12C8 10.8954 8.89543 10 10 10H22C23.1046 10 24 10.8954 24 12V22C24 23.1046 23.1046 24 22 24H10C8.89543 24 8 23.1046 8 22V12Z"
              stroke="#fff"
              stroke-width="1.8"
            />
            <path
              d="M12 10V8.5C12 7.67157 12.6716 7 13.5 7H18.5C19.3284 7 20 7.67157 20 8.5V10"
              stroke="#fff"
              stroke-width="1.8"
      ...
      <nav class="supplier__nav">
        ...
        >
          <svg viewBox="0 0 20 20" width="16" height="16" fill="currentColor">
            <path
              fill-rule="evenodd"
              d="M.99 5.24A2.25 2.25 0 0 1 3.25 3h13.5A2.25 2.25 0 0 1 19 5.24l.236 1.408.01.093v6.436a2.25 2.25 0 0 1-2.25 2.25H3.25A2.25 2.25 0 0 1 1 13.177V6.74l.236-1.408L19 5.24ZM3.25 4.5a.75.75 0 0 0-.75.75v.5l.01.1h12.48l.01-.1v-.5a.75.75 0 0 0-.75-.75H3.25ZM2.25 7v5.677a.75.75 0 0 0 .75.75h13.5a.75.75 0 0 0 .75-.75V7H2.25Z"
              clip-rule="evenodd"
            />
          </svg>
          <span>{{ shopName }}</span>
        ...
        <RouterLink :to="{ name: 'Supplier Products' }" class="supplier__nav-link">
          <svg viewBox="0 0 20 20" width="16" height="16" fill="currentColor">
            <path
              d="M7 3.5A1.5 1.5 0 0 1 8.5 2h3.879a1.5 1.5 0 0 1 1.06.44l1.122 1.12A1.5 1.5 0 0 0 15.62 4H16.5A1.5 1.5 0 0 1 18 5.5v9A1.5 1.5 0 0 1 16.5 16h-13A1.5 1.5 0 0 1 2 14.5v-9A1.5 1.5 0 0 1 3.5 4h.879a1.5 1.5 0 0 1 1.06-.44L7 3.5Z"
            />
          </svg>
